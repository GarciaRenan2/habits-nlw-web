  ...
  return (
    <form onSubmit={creatNewHabit} className="w-full flex flex-col mt-6">
      ...
      <div className="mt-6 flex flex-col gap-3">
        {availableWeekDays.map((weekday: string, index: number) => {
          return (
            <Checkbox.Root
              key={weekday}
      ...
      <button
        type="submit"
        className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 font-semibold bg-green-400 hover:bg-green-500 transition-colors transition-colors"
      >
